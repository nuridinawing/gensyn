...
# Remove Old files
rm -rf officialauto.zip nonofficialauto.zip nonofficialauto2.zip
...
wget https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/nonofficialauto2.zip && \
unzip nonofficialauto2.zip && \
cd ~/rl-swarm
