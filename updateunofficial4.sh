...
# Remove Old files
rm -rf officialauto.zip nonofficialauto.zip nonofficialauto2.zip nonofficialauto3.zip nonofficialauto4.zip
...
wget https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/nonofficialauto4.zip && \
unzip nonofficialauto4.zip && \
cd ~/rl-swarm
