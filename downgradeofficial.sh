...
# Remove Old files
rm -rf officialauto.zip nonofficialauto.zip downgradeofficialauto.zip
...
wget https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/downgradeofficialauto.zip && \
unzip downgradeofficialauto.zip && \
cd ~/rl-swarm
