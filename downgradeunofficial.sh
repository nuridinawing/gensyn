...
# Remove Old files
rm -rf officialauto.zip nonofficialauto.zip downgradeofficialauto.zip downgradenonofficialauto.zip
...
wget https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/downgradenonofficialauto.zip && \
unzip downgradenonofficialauto.zip && \
cd ~/rl-swarm
